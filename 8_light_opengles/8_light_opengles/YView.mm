...
//        1.0, 1.0,
    ...
    m3dRotationMatrix44(r_matrix_init, m3dDegToRad(45.0),  0.0, 1.0, 0.0);
    m3dCopyMatrix44(_model_copy, _model);
...
//    redius_z += 1.0;
    ...
    m3dTranslationMatrix44(Ltranslation_init, 0.5, 0.0, 0.0);
    m3dCopyMatrix44(_Lmodel_copy, _Lmodel);
    ...
    glBindBuffer(GL_ARRAY_BUFFER, VBO);
    glVertexAttribPointer(_positionY, 3, GL_FLOAT, GL_FALSE, 0, (void*)0);
    ...
    glVertexAttribPointer(_LpositionY, 3, GL_FLOAT, GL_FALSE, 0, (void*)0);
